...
class TrackedSubject(object):
    ...
    def get_eye_image_from_landmarks(subject, eye_image_size):
        ...
        try:
            ...
            # eye center coordinate lx, rx, ly, ry
            lefteye_center_coordinates = [lefteye_center_x, lefteye_center_y]
            righteye_center_coordinates = [righteye_center_x, righteye_center_y]
            ...
            return left_eye_color_resized, right_eye_color_resized, lefteye_center_coordinates, righteye_center_coordinates, left_bb, right_bb
