...
def get_error(GT, E, center):
    import math
    #center에서 각각의 endpoint를 잇는 직선사이의 각.
    error = abs(math.atan(abs(E[1] - center[1])/abs(E[0] - center[0])) -math.atan(abs(GT[1]-center[1])/abs(GT[0]-center[0])))
    #라디안을 degree로 변환.
